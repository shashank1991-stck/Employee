...
const minify = true;
const hash = true;
const shellFile = "D:/Workspaces/sts/employee/target/vaadin-flow-bundle.html";
const fragmentFiles = [];
const es6SourceDirectory = "D:/Workspaces/sts/employee/target/frontend";
const targetDirectory = "D:/Workspaces/sts/employee/target/classes/META-INF/resources";
const es5ConfigurationName = "frontend-es5";
const es6ConfigurationName = "frontend-es6";
...
const babelPresetEnvNoModules = babelPresetEnv;
        ...
        del([configurationTargetDirectory], {force: true})
            .then(() => {
                ...
                if (transpileJs) {
                    ...
                    initialStream = initialStream.pipe(gulpIf(/\.js$/, new SafeTransform('babel', babelTransform, {plugins: ['babel-plugin-external-helpers'], presets: [babelPresetEnvNoModules]})));
                }
